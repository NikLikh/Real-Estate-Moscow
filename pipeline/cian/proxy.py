...
from pipeline.cian.runtime import EndpointDriver, EndpointKind
...
async def _preflight_vpn_candidate(pw, candidate, retries=2):
    from pipeline.cian.vpn_ext import check_vpn_ip, launch_vpn_context
...
async def preflight_endpoints(cfg, candidates=None, runtime_only=True):
    ...
    from pipeline.cian.vpn_ext import ensure_extensions
