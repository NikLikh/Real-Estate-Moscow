...
from proxy_farm.validator import check_connectivity, check_cian
...
async def _light_cycle(pool: HttpPool, cfg: dict):
    from proxy_farm.sources import cyberghost, free_lists, monosans, oneclickvpn
...
async def _heavy_cycle(pool: HttpPool, cfg: dict):
    from proxy_farm.sources import browsec
