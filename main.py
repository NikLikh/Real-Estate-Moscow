...
def main():
    ...
    sub.add_parser("scrape", help="парсинг cian.ru (один прогон)")
    ...
    if args.command == "scrape":
        ...
        if args.target == "kaggle":
            from pipeline.kaggle.loader import main as kaggle_main

            kaggle_main()
        elif args.target == "angultiaev":
            from pipeline.kaggle.angultiaev import main as angultiaev_main
